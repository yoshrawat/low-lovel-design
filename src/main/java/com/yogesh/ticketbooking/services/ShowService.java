...
public class ShowService {
  ...
  private boolean checkIfShowCreationAllowed(
      final Screen screen, final Date startTime, final Integer durationInSeconds) {
    // TODO: Implement this. This method will return whether the screen is free at a particular time
    // for
    // specific duration. This function will be helpful in checking whether the show can be
