...
public class TheatreService {
  ...
  public Screen createScreenInTheatre(
      @NonNull final String screenName, @NonNull final Theatre theatre) {
  ...
  public Seat createSeatInScreen(
      @NonNull final Integer rowNo, @NonNull final Integer seatNo, @NonNull final Screen screen) {
