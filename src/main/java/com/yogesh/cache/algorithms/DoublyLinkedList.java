...
/**
 * An object which support creating a list with non-contiguous memory allocation. You cannot access
 * a random element directly using index. But if you have a pointer to a node, then you can traverse
 * the list both in forward and backward direction in the list.
 *
...
public class DoublyLinkedList<E> {
   ...
   * from the memory. Just that it will be removed from the list and becomes orphaned.
   *
