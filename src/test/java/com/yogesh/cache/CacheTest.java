...
import com.yogesh.cache.factories.*;
import org.junit.jupiter.api.*;

import static org.junit.jupiter.api.Assertions.*;

/**
 * @author neeraj on 26/07/20 Copyright (c) 2019, lld-cache. All rights reserved.
 */
public class CacheTest {
  ...
  public void itShouldBeAbleToGetAndAddItemsInTheCache() {
    ...
    assertEquals(
        1,
        cache.get(
            1)); // Accessing 1 after 2 got inserted which makes 2 the least recently used till now.
    cache.put(3, 3);
